    ...
    <div class="form-group row">
        ...
        <div class="col-8">
            <div class="input-group">
                ...
                <input id="nome" name="nome" value="<?=$aluno->nome;?>" placeholder="informe seu nome" type="text"
                    class="form-control" aria-describedby="nomeHelpBlock" required="required">
            </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-8">
            <div class="input-group">
                ...
                <input id="idade" name="idade" value="<?=$aluno->idade;?>" placeholder="informe sua idade" type="text"
